...
//return:	TRUE/FALSE
#define SM_SET_NUMBER_OF_ROW	(WM_USER + 105)

//get the number of col of the form
//wParam:	n/a(=0);
//lParam:	n/a(=0);
//return:	the current number of colomn;
#define SM_GET_NUMBER_OF_COL	(WM_USER + 106)
//set the number of col of the form
//wParam:	n/a(=0);
//lParam:	new number of row
//return:	TRUE/FALSE
#define SM_SET_NUMBER_OF_COL	(WM_USER + 107)
