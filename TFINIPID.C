...
//	LPCOBJ			_lpCobj_PrivDV, _lpCobj_PrivMV, _lpCobj_PrivCV;
	...
	if ( wNo_ == MDMCIRVD_p )
		MFPUWRITE( _lppu, MDMCIRVD_p, WORD, 4 );
	if ( wNo_ == MDMCIRVD_m )
		MFPUWRITE( _lppu, MDMCIRVD_m, WORD, 3 );
	if ( wNo_ == MDMCIRVD_nd )
		MFPUWRITE( _lppu, MDMCIRVD_nd, WORD, 3 );
	if ( wNo_ == MDMCIRVD_N )
	...
	if ( wNo_ == MDMCIRVD_BIGCOND )
		MFPUWRITE( _lppu, MDMCIRVD_BIGCOND, REAL, 50 );
