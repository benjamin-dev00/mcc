...
void DeltMCV( LPCOBJPRIV lpCobj_All_, LPCOBJPRIVMV lpCobj_PrivMV_,
				...
				LPCOBJPRIVDV lpCobj_PrivDV_ )
{
	...
	for( _j = 0; _j < lpCobj_All_->m; _j++ )
	{
		...
		PRIVMVGET( lpCobj_PrivMV_, _j, 0 )->MData -= _ini;
		PRIVMVGET( lpCobj_PrivMV_, _j, 0 )->MSample -= _ini;
		PRIVMVGET( lpCobj_PrivMV_, _j, 0 )->MIrv -= _ini;
		...
		PRIVMVGET( lpCobj_PrivMV_, _j, 0 )->MLastIRV -= _ini;
		PRIVMVGET( lpCobj_PrivMV_, _j, 0 )->MLastHigh -= _ini;
		PRIVMVGET( lpCobj_PrivMV_, _j, 0 )->MLastLow -= _ini;
	...
	for( _i = 0; _i < lpCobj_All_->p; _i++ )
	{
		...
		PRIVCVGET( lpCobj_PrivCV_, _i, 0 )->CLastHigh -= _ini;
		PRIVCVGET( lpCobj_PrivCV_, _i, 0 )->CLastLow -= _ini;
